...
- quais as perguntas que você [responde](init_botao)
...
- [jajajajajajajaja](risada)
- [rsrsrsrsrs](risada)
- rsrs
- rosos
- [pala]
- chorei de [rir](risada)
- ri
- rachei
- morri
...
## intent:clicou_login_corp
- login_corp

## intent:clicou_equipamentos_corp
- equipamentos_corp

## intent:senha_bloqueada_corp
- senha_bloqueada_corp

## intent:criacao_usuarios_media_central
- criacao_usuarios_media_central

## intent:impressora_corp
- impressora_corp
...
## intent:continuar_conversa
- ok

## intent: clicou_acervo
- acervo

## intent: tutorial_agent_ic
- tutorial_agent_ic
...
- me fala um livro pra ler
- livro
- gostaria de ler um livro
- recomenda um livro
- você gosta de ler?
...
- você é uma criação de quem?
- cadê sua mãe?
- cadê seu pai?
- cadê seus pais?
- como estão seus pais?

## intent:je_ne_parle_pas
- comment ça va?
- ça va bien?
